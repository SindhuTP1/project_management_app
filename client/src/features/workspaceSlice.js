    ...
    extraReducers: (builder)=>{
        ...
        builder.addCase(fetchWorkspaces.fulfilled, (state,action)=>{
            ...
            if(action.payload.length > 0){
                const loacalStorageCurrentWorkspaceId=localStorage.getItem('currentWorkspaceId');
                if(loacalStorageCurrentWorkspaceId){
                    const findWorkspace=action.payload.find((w)=>w.id === loacalStorageCurrentWorkspaceId);
                    if(findWorkspace){
